...
class InviteState extends Equatable {
  ...
  final Map customerFromMobileNumber;
	...
	@override
  List<Object> get props => [loading, error, acceptedList, inviteListLoaded, inviteListLocal, editCreditLoading, editCreditError, editCreditSuccess, inviteBuyerSuccess, inviteHistoryList, inviteHistoryListLoaded, mobileNumberVerified, customerFromMobileNumber];
