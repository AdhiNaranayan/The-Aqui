...
class DashBaordPageState extends State<DashBaordPage> {
  ...
  // function to get createsendoptions
    ...
    const DropdownMenuItem(
     ...
     DropdownMenuItem(
      value: '2',
      child: customerCurrentScreen == 'Seller' ? const Text('Invite Buyer') : const Text('Invite Seller'),
    ),
    const DropdownMenuItem(
      value: '3',
  ...
  Widget build(BuildContext context) {
    ...
    return StoreConnector<AppState, Store<AppState>>(
      ...
      builder: (BuildContext context, store) {
        ...
        final Map<String, dynamic> customerData = store.state.authState.customerData;
        ...
        final Map<String, dynamic> dashboardData = store.state.dashboardState.dashboardData;
        final bool businessAddStatus = store.state.businessState.businessAddStatus;
        ...
        final bool newBusiness = StoreProvider.of<AppState>(context).state.dashboardState.newBusiness;  
      ...
      if (customerCurrentScreen == 'Seller') {
       ...
       if (newBusiness == true) {
        ...
        if (customerData.isNotEmpty && customerData['CustomerCategory'].isNotEmpty) {
          if (customerData['CustomerCategory'] == 'Buyer' && customerCurrentScreen != 'Buyer') {
        ...
        if (businessAddStatus == false && businessAddError.isNotEmpty && businessIsSuccess == 2) {
        ...
        if (dashboardData.isNotEmpty) {
          if (dashboardData['OverDueAmount'] != null && dashboardData['DueTodayAmount'] != null && dashboardData['UpComingAmount'] != null) {
            // calculate percentage
          final totalValue = dashboardData['OverDueAmount'] + dashboardData['DueTodayAmount'] + dashboardData['UpComingAmount'];
          if (totalValue != 0) {
          if (dashboardData['overDueAmount'] != 0 ) {
          final overDueValue1 = (dashboardData['OverDueAmount'] / totalValue) * 100;
          overDueValue =  double.parse(overDueValue1.toStringAsFixed(8));
          } else {
            overDueValue = 0;
          }
          if (dashboardData['DueTodayAmount'] != 0) {
          final dueTodayValue1 = (dashboardData['DueTodayAmount'] / totalValue) * 100;
          dueTodayValue = double.parse(dueTodayValue1.toStringAsFixed(0));
          } else {
            dueTodayValue = 0;
          }
          if (dashboardData['UpComingAmount'] != 0) {
          final upcomingValue1= (dashboardData['UpComingAmount'] / totalValue) * 100;
        ...
        void handleCreateSendOptionChange (String value) {
          ...
          if (value == '2'){
            ...
            Navigator.push(context,
            MaterialPageRoute(builder: (context) => const InviteListPage()));
          }
        }
        ...
        return Scaffold(
          ...
          appBar: PreferredSize(
            ...
            child: WidgetHelper.getAppBar(context, 'Dashboard', openDrawer, selectedUserType == UserTypes.seller ? Colors.orange : Colors.deepPurple.shade900, onAddClickDashboardPage),
          ),
          bottomNavigationBar: const BottomNavigation(),
          drawer: WidgetHelper.leftNavigationBar(context, screenIndex, customerData['ContactName'], customerData['Mobile'], selectedUserType == UserTypes.seller ? Colors.orange : Colors.deepPurple.shade900),
          body: Container(
          ...
          image: DecorationImage(
            ...
            const AssetImage('assets/images/ic_dashboardbg_seller.png'),
            fit: BoxFit.cover,
          ),
        ),
        child:
        loading || businessAddLoading ? 
        const CircularLoadingOverlay() : 
        ListView(
          children: <Widget>[
            SizedBox(
              height: AppConfig.isPortrait(context) ? AppConfig.size(context, 10) : AppConfig.size(context, 30),
            ),
              Row(
                ...
                children: <Widget>[
                   Container(
                      ...
                      child: SegmentedButton(
                        style: SegmentedButton.styleFrom(
                          backgroundColor: selectedUserType == UserTypes.seller ? Colors.blue : Colors.orange, // change color with customertype
                          foregroundColor: Colors.white,
                          selectedForegroundColor: Colors.white,
                          selectedBackgroundColor:
                          selectedUserType == UserTypes.seller ? Colors.orange.shade600 : Colors.deepPurple.shade900,
                        ...
                        onSelectionChanged: ((
                          ...
                          if (newSelection.contains(UserTypes.seller)) {
                            if (customerCurrentScreen != 'Seller') {
                              setState(() {
                                selectedUserType = UserTypes.seller;
                              });
                              ...
                              store.dispatch(BusinessIssuccessAction(isSuccess: 0));
                              store.dispatch(DashboardDataAction(dashboardData: {}));
                              store.dispatch(UpdateCustomerCurrentScreen('Seller'));
                              store.dispatch(getDashboardDataAction);
                              store.dispatch(UpdateMyBusinessList(myBusinessList: []));
                              store.dispatch(UpdateAcceptedList(acceptedList: []));
                              store.dispatch(UpdateBusinessListLoaded(businessListLoaded: 0));
                              store.dispatch(UpdateInviteListLocal(inviteListLocal: []));
                              store.dispatch(UpdateInviteListLoaded(inviteListLoaded: false));
                              store.dispatch(UpdateInvoiceList(invoiceList: {}));
                              store.dispatch(UpdateInvoiceListLocal(invoiceListLocal: []));
                              store.dispatch(UpdateInvoiceListLoaded(invoiceListLoaded: 0));
                              store.dispatch(UpdateInvoiceStatusType(invoiceStatusType: 'All'));
                              store.dispatch(UpdatePaymentsList(paymentList: {}));
                              store.dispatch(UpdatePaymentsListLocal(paymentListLocal: []));
                              store.dispatch(UpdatePaymentsListLoaded(paymentListLoaded: 0));
                              store.dispatch(UpdateInviteHistoryList(inviteHistoryList: []));
                              store.dispatch(UpdateUserList([]));
                              store.dispatch(UpdateUserListLoaded(false));
                            }
                            // seller selected
                          } else if (newSelection.contains(UserTypes.buyer)) {
                  ...
                  Container(
                      ...
                      child: DropdownButton(
                        items: getCreateSendOptions(customerCurrentScreen),
                        onChanged: (value) {
                          // on change value
              ...
              SizedBox(
                height: AppConfig.isPortrait(context) ? AppConfig.size(context, 20) : AppConfig.size(context, 30),
              ),
              Padding(
                padding: const EdgeInsets.only(left: 10, right: 10),
                child: Container(
                  ...
                  child: Row(children: <Widget>[
                    SizedBox(
                      ...
                      child: AspectRatio(
                        aspectRatio: 1,
                        child: 
                        overDueValue == 0 && dueTodayValue == 0 && upcomingValue == 0 ?
                    ...
                    SizedBox(
                      width: AppConfig.isPortrait(context) ? screenWidth * 0.40 : AppConfig.size(context, 30),
                      child: SizedBox(
                        child: InkWell(
                          onTap: () => {
                            store.dispatch(UpdateInvoiceStatusType(invoiceStatusType: 'Overdue')),
                            store.dispatch(UpdateSelectedBottomNavIndexAction(3)),
                            // navigate to invoice page
                            Navigator.push(context, 
                            MaterialPageRoute(builder: (context) => const InvoicePage())),
                            ...
                            children: <Widget>[
                                ...
                                const SizedBox(width: 10),
                                  ...
                                  Column(
                                    ...
                                    style: TextStyle(
                                     ...
                                     Text(
                                    dashboardData['OverDueAmount'] != null ? '₹ ${dashboardData['OverDueAmount']}' : '₹ 0',
                                    style: TextStyle(
                                      fontSize: AppConfig.isPortrait(context) ? AppConfig.size(context, 12) : AppConfig.size(context, 14),
                                      color: Colors.red,
                              ...
                              Row(
                                children: <Widget>[
                                  ...
                                  InkWell(
                                    onTap: () => {
                                      store.dispatch(UpdateInvoiceStatusType(invoiceStatusType: 'Due Today')),
                                      store.dispatch(UpdateSelectedBottomNavIndexAction(3)),
                                      // navigate to invoice page
                                      Navigator.push(context, 
                                      MaterialPageRoute(builder: (context) => const InvoicePage())),
                                    ...
                                    child: Column(
                                      ...
                                      style: TextStyle(
                                       ...
                                       Text(
                                      dashboardData['DueTodayAmount'] != null ? '₹ ${dashboardData['DueTodayAmount']}' : '₹ 0',
                                      style: TextStyle(
                                        fontSize: AppConfig.isPortrait(context) ? AppConfig.size(context, 12) : AppConfig.size(context, 14),
                                        color: Colors.orange.shade800,
                                        fontWeight: FontWeight.bold,
                              ...
                              Row(
                                children: <Widget>[
                                  ...
                                  InkWell(
                                    onTap: () => {
                                      store.dispatch(UpdateInvoiceStatusType(invoiceStatusType: 'Upcoming')),
                                      store.dispatch(UpdateSelectedBottomNavIndexAction(3)),
                                      // navigate to invoice page
                                      Navigator.push(context, 
                                      MaterialPageRoute(builder: (context) => const InvoicePage())),
                                    ...
                                    child: Column(
                                      ...
                                      style: TextStyle(
                                       ...
                                       Text(
                                      dashboardData['UpcomingAmount'] != null ? '₹ ${dashboardData['UpcomingAmount']}' : '₹ 0',
                                      style: TextStyle(
                                        fontSize: AppConfig.isPortrait(context) ? AppConfig.size(context, 12) : AppConfig.size(context, 14),
                                        color: const Color.fromARGB(255, 1, 90, 4),
                                        fontWeight: FontWeight.bold,
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    width: AppConfig.isPortrait(context) ? (screenWidth - 40) * 0.33 : AppConfig.size(context, 30),
                    height: AppConfig.isPortrait(context) ? screenHeight / 12 : AppConfig.size(context, 60),
                    child: Stack(
                      children: <Widget>[
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                children: <Widget>[
                                  Text(
                                  customerCurrentScreen == 'Seller' ? 'Payment' : 'Payment Invoice',
                                  style: TextStyle(
                                    fontSize: AppConfig.isPortrait(context) ? AppConfig.size(context, 12) : AppConfig.size(context, 14),
                                    fontWeight: FontWeight.w400,
                                  ),
                                ...
                                Text(
                                  customerCurrentScreen == 'Seller' ? 'Acknowledgement' : 'Acceptance',
                                  style: TextStyle(
                                    fontSize: AppConfig.isPortrait(context) ? AppConfig.size(context, 11) : AppConfig.size(context, 14),
                                    fontWeight: FontWeight.w400,
                                  ),
                                ),
                      ...
                      Positioned(
                              ...
                              child:Container(
                                  ...
                                  child: Text(
                                    customerCurrentScreen == 'Seller' ? dashboardData['PaymentAcknowledgement'] != null ? '${dashboardData['PaymentAcknowledgement']}' : '0' : dashboardData['InvoiceCount'] != null ? '${dashboardData['InvoiceCount']}' : '0',
                                    style: TextStyle(
                                      color: Colors.white,
                                      fontSize: AppConfig.isPortrait(context) ? AppConfig.size(context, 12) : AppConfig.size(context, 12),
                                    ),
                    ...
                    child: Stack(
                      children: <Widget>[
                        Padding(
                          ...
                          child: InkWell(
                            onTap: () => {
                             store.dispatch(UpdateSelectedBottomNavIndexAction(3)),
                              store.dispatch(UpdateInvoiceStatusType(invoiceStatusType: 'Disputed')),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                children: <Widget>[
                                  Text(
                                  customerCurrentScreen == 'Seller' ? 'Disputed' : 'Seller',
                                  style: TextStyle(
                                    fontSize: AppConfig.isPortrait(context) ? AppConfig.size(context, 12) : AppConfig.size(context, 14),
                                    fontWeight: FontWeight.w400,
                                  ),
                                ...
                                Text(
                                  customerCurrentScreen == 'Seller' ? 'Invoices' : 'Requests',
                                  style: TextStyle(
                                    fontSize: AppConfig.isPortrait(context) ? AppConfig.size(context, 12) : AppConfig.size(context, 14),
                                    fontWeight: FontWeight.w400,
                                  ),
                      ...
                      Positioned(
                              ...
                              child:Container(
                                  padding: const EdgeInsets.all(1),
                                  decoration: BoxDecoration(
                                    color: customerCurrentScreen == 'Seller' ? Colors.red : Colors.green,
                                    borderRadius: BorderRadius.circular(50),
                                  ),
                                  constraints: const BoxConstraints(
                                    minWidth: 20,
                                  ...
                                  child: Text(
                                    customerCurrentScreen == 'Seller' ? dashboardData['DisputedInvoice'] != null ? '${dashboardData['DisputedInvoice']}' : '0' : dashboardData['CustomerRequest'] != null ? '${dashboardData['CustomerRequest']}' : '0',
                                    style: TextStyle(
                                      color: Colors.white,
                                      fontSize: AppConfig.isPortrait(context) ? AppConfig.size(context, 12) : AppConfig.size(context, 12),
                                    ),
                    ...
                    child: Stack(
                          ...
                          child: InkWell(
                            onTap: () => {
                              ...
                              MaterialPageRoute(builder: (context) => const InviteHistoryPage()))
                                ...
                                store.dispatch(UpdateSelectedBottomNavIndexAction(4)),
                                Navigator.push(context,
                                MaterialPageRoute(builder: (context) => const PaymentsPage()))
                              }
                            },
                            child: Row(
                              ...
                              children: [
                                ...
                                children: <Widget>[
                                  Text(
                                  customerCurrentScreen == 'Seller' ? 'Buyer' : 'Payment',
                                  style: TextStyle(
                                    fontSize: AppConfig.isPortrait(context) ? AppConfig.size(context, 12) : AppConfig.size(context, 14),
                                    fontWeight: FontWeight.w400,
                                  ),
                                ...
                                Text(
                                  customerCurrentScreen == 'Seller' ? 'Requests' : 'Dispute',
                                  style: TextStyle(
                                    fontSize: AppConfig.isPortrait(context) ? AppConfig.size(context, 12) : AppConfig.size(context, 14),
                                    fontWeight: FontWeight.w400,
                                  ),
                      ...
                      Positioned(
                              ...
                              child:Container(
                                  padding: const EdgeInsets.all(1),
                                  decoration: BoxDecoration(
                                    color: customerCurrentScreen == 'Seller' ? Colors.green : Colors.red,
                                    borderRadius: BorderRadius.circular(50),
                                  ),
                                  constraints: const BoxConstraints(
                                    minWidth: 20,
                                  ...
                                  child: Text(
                                    customerCurrentScreen == 'Seller' ? dashboardData['CustomerRequest'] != null ? '${dashboardData['CustomerRequest']}' : '0' : dashboardData['PaymentDisputed'] != null ? '${dashboardData['PaymentDisputed']}' : '0',
                                    style: TextStyle(
                                      color: Colors.white,
                                      fontSize: AppConfig.isPortrait(context) ? AppConfig.size(context, 12) : AppConfig.size(context, 12),
                                    ),
                       ...
                       Padding(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            ...
                            color: selectedUserType == UserTypes.seller ? Colors.orange : Colors.deepPurple.shade900,
                            fontWeight: FontWeight.bold,
                          ),
                          )
                        ),
                        ...
                        child: LinearProgressIndicator(
                          value: (dashboardData['CreditLimit'] != null && dashboardData['CreditLimit'] != 0 && dashboardData['AvailableCreditLimit'] != null) ? (dashboardData['AvailableCreditLimit']) / dashboardData['CreditLimit'] : 0,
                          backgroundColor: Colors.grey,
                          valueColor: AlwaysStoppedAnimation<Color>(selectedUserType == UserTypes.seller ? Colors.orange : Colors.deepPurple.shade900),
                          minHeight: 8,
                          borderRadius: BorderRadius.circular(10),
                        ),
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  store.dispatch(UpdateSelectedBottomNavIndexAction(2));
                  Navigator.push(context,
