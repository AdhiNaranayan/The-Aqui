                ...
                Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Text('${data['StatusType'] + ' - ' + data['PaidORUnpaid'] ?? ''}', style: TextStyle(color: Colors.white, fontSize: AppConfig.size(context, 14)),),
                    ],
                  ),
                ),
                const SizedBox(height: 5),
...
Future<void> showLoadingUpdate () async {
  ...
  Widget build(BuildContext context ) {
    ...
    print('invoiceCreateLoading $invoiceCreateLoading');
        ...
        createInvoiceClicked () {
          ...
          // alert if invoicenumber is empty
            store.dispatch(createInvoice(<String, dynamic>{
              ...
              "TemporaryCreditAmount": sellerBusinessCustomerList.firstWhere((element) => element['_id'] == filterBuyer)['AvailableTemporaryLimit'],
