...
class CalendarPageState extends State<CalendarPage> {
  ...
  String startDayofMonth = DateFormat('yyyy-MM-01').format(DateTime.now());
  ...
  Widget build(BuildContext context) {
    ...
    return StoreConnector<AppState, Store<AppState>>(
      ...
      builder: (BuildContext context, store) {
        ...
        Future navigateToInvoicePage (String date1, String date2) async {
        ...
        Future fetchMonthlyData (String date1, String date2) async {
        ...
        if (invoiceListLocal.isNotEmpty) {
          ...
          for (var i=0; i<invoiceListLocal.length; i++) {
            var invoiceDate = invoiceListLocal[i]['InvoiceDate'];            
          ...
          Expanded(
            child: CellCalendar(
              ...
              onCellTapped: (date) {
                ...
                navigateToInvoicePage(date1, date2);
              },
              ...
              onPageChanged: (firstDate, lastDate) => {
                ...
                fetchMonthlyData(DateFormat('yyyy-MM-dd').format(firstDate), DateFormat('yyyy-MM-dd').format(lastDate))
              },
            ),
          ),
        ],
