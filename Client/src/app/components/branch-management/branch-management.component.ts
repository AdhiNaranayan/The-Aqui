...
import { BusinessAndBranchesComponent } from '../Modals/business-and-branches/business-and-branches.component';
...
export class BranchManagementComponent implements OnInit {
  ...
  Service_Loader() {
    ...
    const Data = {
      ...
      FilterQuery: Filters,
      Owner: '5f76c79c379dd521ed258058',
      Business: '5f76c7f1379dd521ed258059',
    };
    this.TableLoader();
    // this.BusinessService.BranchList(Data).subscribe(response => {
