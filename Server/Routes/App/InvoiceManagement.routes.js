module.exports = function (app) {
    ...
    app.post('/APP_API/InvoiceManagement/CheckInvoiceNumberDuplicateNew', Controller.InvoiceNumberDuplicateCheckNew);


    // app.post('/APP_API/InvoiceManagement/generatePdf', Controller.generatePdf);
    // app.post('/APP_API/InvoiceManagement/getBase64Pdf', Controller.getBase64Pdf);
};