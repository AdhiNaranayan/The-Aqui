module.exports = function (app) {
    ...
    app.post('/APP_API/HundiScoreManagement/ConnectedCustomerWithAdvancedFilter', Controller.ConnectedCustomerWithFilter);



      // Active/Inactive StatusType updating for Buyer
      app.post('/APP_API/HundiScoreManagement/BuyerStatusType_Update', Controller.BuyerStatusType_Update);
      // Active/Inactive status StatusType for Seller
      app.post('/APP_API/HundiScoreManagement/SellerStausType_Update', Controller.SellerStatusType_Update);
 }; 