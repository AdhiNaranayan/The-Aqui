                    ...
                    (err,res)=>{
                        if (err) {
                           ...
                           res.map(async inv=>{
                            ...
                            mPaidAmount = inv.PaidAmount + obj.InProgressAmount;
                          
                        //Status Cleared/Uncleared
                            var StatusType;
                           
                            if ( inv.InvoiceAmount === mPaidAmount ) {
                                StatusType = 'cleared';
                            } else {
                        ...
                        //Chart Amount Update
                            if (inv.InvoiceAmount > mPaidAmount) {
                             chartUpdtae = inv.InvoiceAmount - mPaidAmount;
                            } else if (mPaidAmount > inv.InvoiceAmount){
                             chartUpdtae = mPaidAmount - inv.InvoiceAmount;
                            }
